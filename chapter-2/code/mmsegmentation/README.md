...
Use the following commands to setup the conda environment:

1. `conda create -n <environment-name> python==3.8`
2. `cd <mmsegmentation-folder>`
3. `conda activate <environment-name>`
4. `pip install -e .`
5. `pip install -r requirements.txt`
6. `pip install -U openmim`
7. `mim install mmcv-full==1.6.2`
